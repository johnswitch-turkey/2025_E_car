        ...
        // } else { // 按键释放
            ...
            //     if (pressDurationMs < LONG_PRESS_THRESHOLD_MS) {
					...
					case 0:
						...
						break;
					case 1:
						DL_GPIO_clearPins(LEDS_LED_1_PORT,LEDS_LED_1_PIN);
						DL_GPIO_setPins(LEDS_LED_2_PORT,LEDS_LED_2_PIN);
						DL_GPIO_setPins(LEDS_LED_3_PORT,LEDS_LED_3_PIN);
						break;
					case 2:		
						DL_GPIO_setPins(LEDS_LED_1_PORT,LEDS_LED_1_PIN);
						DL_GPIO_clearPins(LEDS_LED_2_PORT,LEDS_LED_2_PIN);
						DL_GPIO_setPins(LEDS_LED_3_PORT,LEDS_LED_3_PIN);			
						break;
					case 3:
						DL_GPIO_clearPins(LEDS_LED_1_PORT,LEDS_LED_1_PIN);
					...
					case 4:
						DL_GPIO_setPins(LEDS_LED_1_PORT,LEDS_LED_1_PIN);
						DL_GPIO_setPins(LEDS_LED_2_PORT,LEDS_LED_2_PIN);
						DL_GPIO_clearPins(LEDS_LED_3_PORT,LEDS_LED_3_PIN);
						break;
					case 5:
						DL_GPIO_clearPins(LEDS_LED_1_PORT,LEDS_LED_1_PIN);
						DL_GPIO_setPins(LEDS_LED_2_PORT,LEDS_LED_2_PIN);
