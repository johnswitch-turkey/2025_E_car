...
{	
    ...
    if (!DL_GPIO_readPins(GPIO_GREY_SENSOR_L3_PORT,GPIO_GREY_SENSOR_L3_PIN)) {R2_Val = 1;} else {R2_Val = 0;}
    if (!DL_GPIO_readPins(GPIO_GREY_SENSOR_L3_PORT,GPIO_GREY_SENSOR_L3_PIN)) {R3_Val = 1;} else {R3_Val = 0;}
